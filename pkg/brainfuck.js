...
export class BF {
    ...
    static __wrap(ptr) {
        const obj = Object.create(BF.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_bf_free(ptr);
    }
    /**
    * @returns {BF}
    */
    static new() {
        const ret = wasm.bf_new();
        return BF.__wrap(ret);
    }
    /**
    ...
    */
    set_code(c) {
        ...
        wasm.bf_set_code(this.ptr, ptr0, len0);
    }
    /**
    ...
    */
    get_state() {
        try {
            ...
            wasm.bf_get_state(retptr, this.ptr);
    ...
    */
    step() {
        const ret = wasm.bf_step(this.ptr);
        return ret !== 0;
    }
    /**
    * @param {number} steps
    ...
    */
    steps(steps) {
        const ret = wasm.bf_steps(this.ptr, steps);
        return ret !== 0;
    }
}
